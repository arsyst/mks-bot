...
from const import THROTTLE_TIME_OTHER, THROTTLE_TIME_REQUEST

# Разные по продолжительности кэши для разных типов действий
caches = {
    "default": TTLCache(maxsize=int(inf), ttl=THROTTLE_TIME_OTHER),
    "request": TTLCache(maxsize=int(inf), ttl=THROTTLE_TIME_REQUEST)
}
